...
async function findWorkerInOtherRun(repoRoot, runId, workerId) {
...
async function cleanupRun(input) {
	...
	if (input.workerId !== void 0) {
		...
		if (!worker) {
			...
			if (otherRun) throw new Error(`Worker '${input.workerId}' belongs to run '${otherRun}', not '${state.id}'.`);
